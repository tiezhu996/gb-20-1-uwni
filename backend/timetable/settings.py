...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('DB_USER', 'timetable_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'timetable_pass'),
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(hours=int(os.environ.get('JWT_REFRESH_TOKEN_LIFETIME', 168))),
}
